//если начать поиск, показыавются подсказки - это хорошо. если не выбирая подсказу, нажать по клавише ентер подсказки остаются висеть и закрывают результаты. но если нажимать на сабмит подсказки азкрываются.
